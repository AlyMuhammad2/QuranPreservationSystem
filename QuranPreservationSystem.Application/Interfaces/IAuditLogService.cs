...
public interface IAuditLogService
{
    ...
    Task<IEnumerable<Domain.Entities.AuditLogs.StudentLog>> GetAllStudentLogsAsync(DateTime? startDate, DateTime? endDate, int pageNumber = 1, int pageSize = 50);
    ...
    Task<IEnumerable<Domain.Entities.AuditLogs.TeacherLog>> GetAllTeacherLogsAsync(DateTime? startDate, DateTime? endDate, int pageNumber = 1, int pageSize = 50);
    ...
    Task<IEnumerable<Domain.Entities.AuditLogs.CenterLog>> GetAllCenterLogsAsync(DateTime? startDate, DateTime? endDate, int pageNumber = 1, int pageSize = 50);
    ...
    Task<IEnumerable<Domain.Entities.AuditLogs.CourseLog>> GetAllCourseLogsAsync(DateTime? startDate, DateTime? endDate, int pageNumber = 1, int pageSize = 50);
    ...
    Task<IEnumerable<Domain.Entities.AuditLogs.ExamLog>> GetAllExamLogsAsync(DateTime? startDate, DateTime? endDate, int pageNumber = 1, int pageSize = 50);
    ...
    Task<IEnumerable<Domain.Entities.AuditLogs.EnrollmentLog>> GetAllEnrollmentLogsAsync(DateTime? startDate, DateTime? endDate, int pageNumber = 1, int pageSize = 50);
    ...
    Task<IEnumerable<Domain.Entities.AuditLogs.HafizRegistryLog>> GetAllHafizRegistryLogsAsync(DateTime? startDate, DateTime? endDate, int pageNumber = 1, int pageSize = 50);
    ...
    Task<IEnumerable<Domain.Entities.AuditLogs.UserLog>> GetAllUserLogsAsync(DateTime? startDate, DateTime? endDate, int pageNumber = 1, int pageSize = 50);
}

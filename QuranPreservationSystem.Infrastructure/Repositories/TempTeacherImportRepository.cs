...
{
    /// <summary>
    /// مخزن استيراد المدرسين المؤقت
    /// </summary>
    public class TempTeacherImportRepository : GenericRepository<TempTeacherImport>, ITempTeacherImportRepository
    {
        public TempTeacherImportRepository(AppDbContext context) : base(context)
        {
        }

        public async Task<IEnumerable<TempTeacherImport>> GetByStatusAsync(ImportStatus status)
        {
            return await _dbSet
        ...
        public async Task<IEnumerable<TempTeacherImport>> GetByBatchIdAsync(string batchId)
        {
            return await _dbSet
        ...
        public async Task<IEnumerable<TempTeacherImport>> GetPendingImportsAsync()
        {
            return await _dbSet

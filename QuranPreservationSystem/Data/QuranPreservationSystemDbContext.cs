...
using QuranPreservationSystem.Models;

namespace QuranPreservationSystem.Data
{
    public class QuranPreservationSystemDbContext : DbContext
    {
        public QuranPreservationSystemDbContext(DbContextOptions<QuranPreservationSystemDbContext> options)
            : base(options)
        {
        }
